 ...
 * the License.
 */
package org.cruxframework.crux.plugin.gadget.client.features.osapi.people;
...
public class Person extends JavaScriptObject {
  ...
  public final native String getDisplayName() /*-{
    return (this[@org.cruxframework.crux.plugin.gadget.client.features.osapi.people.Person::DISPLAY_NAME] == null) ? null : this[@org.cruxframework.crux.plugin.gadget.client.features.osapi.people.Person::DISPLAY_NAME];
  }-*/;
  ...
  public final native String getId() /*-{
    return (this[@org.cruxframework.crux.plugin.gadget.client.features.osapi.people.Person::ID] == null) ? null : this[@org.cruxframework.crux.plugin.gadget.client.features.osapi.people.Person::ID];
  }-*/;
  ...
  public final native String getThumbnailUrl() /*-{
    return (this[@org.cruxframework.crux.plugin.gadget.client.features.osapi.people.Person::THUMBNAIL_URL] == null) ? null : this[@org.cruxframework.crux.plugin.gadget.client.features.osapi.people.Person::THUMBNAIL_URL];
  }-*/;
}